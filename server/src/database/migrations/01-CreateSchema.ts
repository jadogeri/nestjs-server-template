...
export class CreateSchema1234567890000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_auths" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(150) NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (0), "verificationToken" varchar, "isVerified" boolean NOT NULL DEFAULT (0), "verifiedAt" datetime, "lastLoginAt" datetime, "failedLoginAttempts" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('enabled','disabled','locked') ) NOT NULL DEFAULT ('disabled'), "userId" integer, CONSTRAINT "UQ_a28e912dc6bde5945582f2be0a2" UNIQUE ("email"), CONSTRAINT "REL_3e65bf4e56bde80b7b5e5b9e13" UNIQUE ("userId"), CONSTRAINT "FK_3e65bf4e56bde80b7b5e5b9e133" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_auths"("createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "lastLoginAt", "failedLoginAttempts", "status", "userId") SELECT "createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "lastLoginAt", "failedLoginAttempts", "status", "userId" FROM "auths"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auths" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(150) NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (0), "verificationToken" varchar, "isVerified" boolean NOT NULL DEFAULT (0), "verifiedAt" datetime, "lastLoginAt" datetime, "failedLoginAttempts" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('enabled','disabled','locked') ) NOT NULL DEFAULT ('disabled'), "userId" integer, CONSTRAINT "UQ_a28e912dc6bde5945582f2be0a2" UNIQUE ("email"), CONSTRAINT "REL_3e65bf4e56bde80b7b5e5b9e13" UNIQUE ("userId"))`);
        await queryRunner.query(`INSERT INTO "auths"("createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "lastLoginAt", "failedLoginAttempts", "status", "userId") SELECT "createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "lastLoginAt", "failedLoginAttempts", "status", "userId" FROM "temporary_auths"`);
