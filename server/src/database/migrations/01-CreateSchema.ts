...
export class CreateSchema1234567890000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auths" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(150) NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (0), "verificationToken" varchar, "isVerified" boolean NOT NULL DEFAULT (0), "verifiedAt" datetime, "reactivatedAt" datetime, "reactivateToken" varchar, "lastLoginAt" datetime, "failedLoginAttempts" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('enabled','disabled','locked') ) NOT NULL DEFAULT ('disabled'), "userId" integer, CONSTRAINT "UQ_a28e912dc6bde5945582f2be0a2" UNIQUE ("email"), CONSTRAINT "REL_3e65bf4e56bde80b7b5e5b9e13" UNIQUE ("userId"))`);
        await queryRunner.query(`CREATE TABLE "permissions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "resource" varchar NOT NULL DEFAULT ('auth'), "action" varchar CHECK( "action" IN ('create','read','update','delete','manage') ) NOT NULL DEFAULT ('read'), "description" varchar, CONSTRAINT "UQ_7331684c0c5b063803a425001a0" UNIQUE ("resource", "action"))`);
        await queryRunner.query(`CREATE TABLE "roles" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar, CONSTRAINT "UQ_648e3f5447f725579d7d4ffdfb7" UNIQUE ("name"))`);
        await queryRunner.query(`CREATE TABLE "contacts" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "fullName" varchar(100) NOT NULL, "phone" varchar(20), "email" varchar(50), "fax" varchar(20), "userId" integer NOT NULL, "locationAddress" varchar, "locationCity" varchar, "locationState" varchar, "locationZipcode" varchar, "locationCountry" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_auths" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(150) NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (0), "verificationToken" varchar, "isVerified" boolean NOT NULL DEFAULT (0), "verifiedAt" datetime, "reactivatedAt" datetime, "reactivateToken" varchar, "lastLoginAt" datetime, "failedLoginAttempts" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('enabled','disabled','locked') ) NOT NULL DEFAULT ('disabled'), "userId" integer, CONSTRAINT "UQ_a28e912dc6bde5945582f2be0a2" UNIQUE ("email"), CONSTRAINT "REL_3e65bf4e56bde80b7b5e5b9e13" UNIQUE ("userId"), CONSTRAINT "FK_3e65bf4e56bde80b7b5e5b9e133" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_auths"("createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "reactivatedAt", "reactivateToken", "lastLoginAt", "failedLoginAttempts", "status", "userId") SELECT "createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "reactivatedAt", "reactivateToken", "lastLoginAt", "failedLoginAttempts", "status", "userId" FROM "auths"`);
        await queryRunner.query(`DROP TABLE "auths"`);
        await queryRunner.query(`ALTER TABLE "temporary_auths" RENAME TO "auths"`);
        await queryRunner.query(`CREATE TABLE "temporary_contacts" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "fullName" varchar(100) NOT NULL, "phone" varchar(20), "email" varchar(50), "fax" varchar(20), "userId" integer NOT NULL, "locationAddress" varchar, "locationCity" varchar, "locationState" varchar, "locationZipcode" varchar, "locationCountry" varchar, CONSTRAINT "FK_30ef77942fc8c05fcb829dcc61d" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_contacts"("createdAt", "updatedAt", "id", "fullName", "phone", "email", "fax", "userId", "locationAddress", "locationCity", "locationState", "locationZipcode", "locationCountry") SELECT "createdAt", "updatedAt", "id", "fullName", "phone", "email", "fax", "userId", "locationAddress", "locationCity", "locationState", "locationZipcode", "locationCountry" FROM "contacts"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contacts" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "fullName" varchar(100) NOT NULL, "phone" varchar(20), "email" varchar(50), "fax" varchar(20), "userId" integer NOT NULL, "locationAddress" varchar, "locationCity" varchar, "locationState" varchar, "locationZipcode" varchar, "locationCountry" varchar)`);
        await queryRunner.query(`INSERT INTO "contacts"("createdAt", "updatedAt", "id", "fullName", "phone", "email", "fax", "userId", "locationAddress", "locationCity", "locationState", "locationZipcode", "locationCountry") SELECT "createdAt", "updatedAt", "id", "fullName", "phone", "email", "fax", "userId", "locationAddress", "locationCity", "locationState", "locationZipcode", "locationCountry" FROM "temporary_contacts"`);
        await queryRunner.query(`DROP TABLE "temporary_contacts"`);
        await queryRunner.query(`ALTER TABLE "auths" RENAME TO "temporary_auths"`);
        await queryRunner.query(`CREATE TABLE "auths" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(150) NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (0), "verificationToken" varchar, "isVerified" boolean NOT NULL DEFAULT (0), "verifiedAt" datetime, "reactivatedAt" datetime, "reactivateToken" varchar, "lastLoginAt" datetime, "failedLoginAttempts" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('enabled','disabled','locked') ) NOT NULL DEFAULT ('disabled'), "userId" integer, CONSTRAINT "UQ_a28e912dc6bde5945582f2be0a2" UNIQUE ("email"), CONSTRAINT "REL_3e65bf4e56bde80b7b5e5b9e13" UNIQUE ("userId"))`);
        await queryRunner.query(`INSERT INTO "auths"("createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "reactivatedAt", "reactivateToken", "lastLoginAt", "failedLoginAttempts", "status", "userId") SELECT "createdAt", "updatedAt", "id", "email", "password", "isEnabled", "verificationToken", "isVerified", "verifiedAt", "reactivatedAt", "reactivateToken", "lastLoginAt", "failedLoginAttempts", "status", "userId" FROM "temporary_auths"`);
