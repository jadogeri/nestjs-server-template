...
console.log(`Using refresh token cookie name: ${REFRESH_TOKEN_COOKIE_NAME}`);
  ...
  export const swaggerConfig = new DocumentBuilder()
    ...
    .addServer('https://your-website.com/api', "Production server")
    .addServer('https://staging.your-website.com/api', "Staging server")
    .addServer('http://localhost:3001/api', "Testing server")
